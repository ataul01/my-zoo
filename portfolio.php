  ...
  <div id="wrapper">
    ...
    <section id="inner-headline">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            <h2 class="pageTitle"><span style="color: #fde7cb; font-size: 30px;">Gallery</span></h2>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="row"> 
        <div class="col-md-12">
          <div class="about-logo">
            ...
            <p font_size:40px;>Find in-depth information on Animals & Plants, read about our conservation work in the San Diego Zoo Journal, and explore our blog and media information.</p>
          </div>  
        </div>
      </div> 
    </div>
